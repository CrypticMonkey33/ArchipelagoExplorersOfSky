...
option_name_to_value_dict = {
            "Goal": "goal",
            "ServerVersion": "game_version",
            "BagOnStart": "bag_on_start",
            "Recruitment": "recruit",
            "TeamFormation": "team_form",
            "LevelScaling": "level_scale",
            "RecruitmentEvolution": "recruit_evo",
            "DojoDungeonsRandomization": "dojo_dungeons",
            "ShardFragmentAmount": "required_fragments",
            "ExtraShardsAmount": "total_shards",
            "EarlyMissionsAmount": "early_mission_checks",
            "EarlyOutlawsAmount": "early_outlaw_checks",
            "LateMissionsAmount": "late_mission_checks",
            "LateOutlawsAmount": "late_outlaw_checks",
            "TypeSanity": "type_sanity",
            "StarterOption": "starter_option",
            "IQScaling": "iq_scaling",
            "XPScaling": "xp_scaling",
            "RequiredInstruments": "req_instruments",
            "ExtraInstruments": "total_instruments",
            "HeroEvolution": "hero_evolution",
            "Deathlink": "deathlink",
            "DeathlinkType": "deathlink_type",
            "LegendaryAmount": "legendaries",
            "AllowedLegendaries": "allowed_legendaries",
            "SkyPeakType": "sky_peak_type",
            "SpecialEpisodeSanity": "special_episode_sanity",
            "HintLocationList": "dimensional_scream_list_ints",
            "TrapsAllowed": "allow_traps",
            "InvisibleTraps": "invisible_traps",
            "TrapPercentage": "trap_percent",
            "LongLocations": "long_location",
            "CursedAegisCave": "cursed_aegis_cave",
            "DrinkEvents": "drink_events",
            "SpindaDrinks": "spinda_drinks",
            "ExcludeSpecial": "exclude_special",
            "AllowMissionsEarly": "early_mission_floors",
            "MaxRank": "max_rank",
