...
EOS_item_table = [
    ...
    ItemData("Zero Isle North", 99, ItemClassification.useful, 99, ["Unique", "LateDungeons"], 0x63),
    ItemData("Zero Isle East", 100, ItemClassification.useful, 100, ["Unique", "LateDungeons"], 0x64),
    ItemData("Zero Isle West", 101, ItemClassification.useful, 101, ["Unique", "LateDungeons"], 0x65),
    ItemData("Zero Isle South", 102, ItemClassification.useful, 102, ["Unique", "LateDungeons"], 0x66),
    ItemData("Zero Isle Center", 103, ItemClassification.useful, 103, ["Unique", "LateDungeons"], 0x67),
    ItemData("Destiny Tower", 104, ItemClassification.useful, 104, ["Unique", "LateDungeons"], 0x68),
    ItemData("Oblivion Forest", 107, ItemClassification.useful, 107, ["Unique", "LateDungeons"], 0x6B),
    ItemData("Treacherous Waters", 108, ItemClassification.useful, 108, ["Unique", "LateDungeons"], 0x6C),
    ItemData("Southeastern Islands", 109, ItemClassification.useful, 109, ["Unique", "LateDungeons"], 0x6D),
    ItemData("Inferno Cave", 110, ItemClassification.useful, 110, ["Unique", "LateDungeons"], 0x6E),
