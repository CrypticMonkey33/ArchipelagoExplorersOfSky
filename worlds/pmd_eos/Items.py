...
EOS_item_table = [
    ...
    ItemData("Dark Crater", 67, ItemClassification.progression, 67, ["Unique", "LateDungeons"], 0x43),
    ...
    ItemData("Zero Isle North", 99, ItemClassification.progression, 99, ["Unique", "LateDungeons"], 0x63),
    ItemData("Zero Isle East", 100, ItemClassification.progression, 100, ["Unique", "LateDungeons"], 0x64),
    ItemData("Zero Isle West", 101, ItemClassification.progression, 101, ["Unique", "LateDungeons"], 0x65),
    ItemData("Zero Isle South", 102, ItemClassification.progression, 102, ["Unique", "LateDungeons"], 0x66),
    ItemData("Zero Isle Center", 103, ItemClassification.progression, 103, ["Unique", "LateDungeons"], 0x67),
    ItemData("Destiny Tower", 104, ItemClassification.progression, 104, ["Unique", "LateDungeons"], 0x68),
    ItemData("Oblivion Forest", 107, ItemClassification.progression, 107, ["Unique", "LateDungeons"], 0x6B),
    ItemData("Treacherous Waters", 108, ItemClassification.progression, 108, ["Unique", "LateDungeons"], 0x6C),
    ItemData("Southeastern Islands", 109, ItemClassification.progression, 109, ["Unique", "LateDungeons"], 0x6D),
    ItemData("Inferno Cave", 110, ItemClassification.progression, 110, ["Unique", "LateDungeons"], 0x6E),
