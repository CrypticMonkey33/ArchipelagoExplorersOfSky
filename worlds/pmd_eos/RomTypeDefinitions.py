...
subX_table = [
    ...
    # 0.4.0
    SubXBitfield(89, 6, 1, 1, "Jumpluff's Sky Gift (1st Clearing)", ["Sky Peak 1st Station Pass ", " Sky Peak 2nd Station Pass"], "Filler"),
    SubXBitfield(90, 6, 1, 2, "Jumpluff's Sky Gift (3rd Clearing)", ["Sky Peak 3rd Station Pass ", " Sky Peak 4th Station Pass"], "Filler"),
    SubXBitfield(91, 6, 1, 3, "Jumpluff's Sky Gift (5th Clearing)", ["Sky Peak 5th Station Pass ", " Sky Peak 6th Station Pass"], "Filler"),
    SubXBitfield(92, 6, 1, 4, "Jumpluff's Sky Gift (7th Clearing)", ["Sky Peak 7th Station Pass ", " Sky Peak 8th Station Pass"], "Filler"),
    SubXBitfield(93, 6, 1, 5, "Jumpluff's Sky Gift (Summit)", ["Sky Peak Summit Pass"], "Filler"),
    SubXBitfield(94, 6, 1, 6, "Delibird's Sky Gift (9th Clearing)", ["Sky Peak 9th Station Pass ", " Sky Peak Summit Pass"], "Filler"),
    SubXBitfield(95, 6, 1, 7, "Help Heracross", ["Sky Peak 1st Station Pass ", " Sky Peak 2nd Station Pass"], "Filler"),
    SubXBitfield(96, 7, 0, 0, "Help Happiny (1st Clearing)", ["Sky Peak 1st Station Pass ", " Sky Peak 2nd Station Pass"], "Filler"),
    SubXBitfield(97, 7, 0, 1, "Help Happiny (3rd Clearing)", ["Sky Peak 3rd Station Pass ", " Sky Peak 4th Station Pass"], "Filler"),
    SubXBitfield(98, 7, 0, 2, "Help Happiny (5th Clearing)", ["Sky Peak 5th Station Pass ", " Sky Peak 6th Station Pass"], "Filler"),
    SubXBitfield(99, 7, 0, 3, "Help Happiny (7th Clearing)", ["Sky Peak 7th Station Pass ", " Sky Peak 8th Station Pass"], "Filler"),
    SubXBitfield(100, 7, 0, 4, "Numel's Trade (1st Clearing)", ["Sky Peak 1st Station Pass ", " Sky Peak 2nd Station Pass"], "Filler"),
    SubXBitfield(101, 7, 0, 5, "Numel's Trade (3rd Clearing)", ["Sky Peak 3rd Station Pass ", " Sky Peak 4th Station Pass"], "Filler"),
    SubXBitfield(102, 7, 0, 6, "Numel's Trade (5th Clearing)", ["Sky Peak 5th Station Pass ", " Sky Peak 6th Station Pass"], "Filler"),
    SubXBitfield(103, 7, 0, 7, "Numel's Trade (7th Clearing)", ["Sky Peak 7th Station Pass ", " Sky Peak 8th Station Pass"], "Filler"),
