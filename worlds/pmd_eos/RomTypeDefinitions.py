...
subX_table = [
    ...
    SubXBitfield(19, 2, 0, 3, "Shop Item #10", [], "Filler", "ShopItem"),
    ...
    SubXBitfield(69, 5, 0, 5, "Regice's Gift", ["Defeat Dialga", "Have Ice Key", "Aegis Cave"], "Regice"),
    SubXBitfield(70, 5, 0, 6, "Regirock's Gift", ["Defeat Dialga", "Have Rock Key", "Aegis Cave"], "Regirock"),
    SubXBitfield(71, 5, 0, 7, "Registeel's Gift", ["Defeat Dialga", "Have Steel Key", "Aegis Cave"], "Registeel"),
    SubXBitfield(72, 5, 1, 0, "Regigigas's Gift", ["Defeat Dialga", "Have Ice Key", "Have Rock Key", "Have Steel Key", "Aegis Cave"], "Regigigas"),
