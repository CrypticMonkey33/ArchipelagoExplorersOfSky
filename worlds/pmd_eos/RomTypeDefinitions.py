...
subX_table = [
    ...
    SubXBitfield(46, 3, 1, 6, "Shaymin's Gift", ["Defeat Dialga", "Sky Station Summit Pass"], "Shaymin", "Legendary"),
    ...
    SubXBitfield(60, 4, 1, 4, "Recycle Shop Dungeon #1", [], "Landslide Cave", "ShopItem"),
    SubXBitfield(61, 4, 1, 5, "Recycle Shop Dungeon #2", ["ProgressiveBag1"], "Tiny Meadow", "ShopItem"),
    SubXBitfield(62, 4, 1, 6, "Recycle Shop Dungeon #3", ["ProgressiveBag1"], "Oran Forest", "ShopItem"),
    SubXBitfield(63, 4, 1, 7, "Recycle Shop Dungeon #4", ["ProgressiveBag2", "Formation Control"], "Lake Afar",
                 "ShopItem"),
    SubXBitfield(64, 5, 0, 0, "Recycle Shop Dungeon #5", ["ProgressiveBag2", "Formation Control"], "Zero Isle Center",
                 "ShopItem"),
    SubXBitfield(65, 5, 0, 1, "Sneasel's Gratitude", ["7th Station Pass", "Sky Station Summit Pass"],
                 "Filler", "LateSubX"),
    ...
    SubXBitfield(69, 5, 0, 5, "Regice's Gift", ["Defeat Dialga", "Have Ice Key", "Ice Aegis Cave"], "Regice",
                 "Legendary"),
    SubXBitfield(70, 5, 0, 6, "Regirock's Gift", ["Defeat Dialga", "Have Rock Key", "Ice Aegis Cave"], "Regirock",
                 "Legendary"),
    SubXBitfield(71, 5, 0, 7, "Registeel's Gift", ["Defeat Dialga", "Have Steel Key", "Ice Aegis Cave"], "Registeel",
                 "Legendary"),
    SubXBitfield(72, 5, 1, 0, "Regigigas's Gift", ["Defeat Dialga", "Have Ice Key", "Have Rock Key", "Have Steel Key",
