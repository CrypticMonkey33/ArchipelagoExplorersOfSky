...
subX_table = [
    SubXBitfield(0, 1, 0, 0, "Bag Upgrade 0", ["Clear Beach Cave"], "Bag Upgrade", "ProgressiveBagUpgrade"),
    ...
    SubXBitfield(5, 1, 0, 5, "Bidoof's SE Location", ["None"], "Bidoof's SE", "SpecialDungeonComplete"),
    SubXBitfield(6, 1, 0, 6, "Igglybuff's SE Location", ["None"], "Igglybuff's SE", "SpecialDungeonComplete"),
    SubXBitfield(7, 1, 0, 7, "Sunflora's SE Location", ["None"], "Sunflora's SE", "SpecialDungeonComplete"),
    SubXBitfield(8, 1, 1, 0, "Team Charm SE Location", ["None"], "Team Charm SE", "SpecialDungeonComplete"),
    SubXBitfield(9, 1, 1, 1, "Grovyle + Dusknoir SE location", ["Hidden Land"], "Grovyle + Dusknoir SE",
                 "SpecialDungeonComplete"),
    SubXBitfield(10, 1, 1, 2, "Shop Item #1", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(11, 1, 1, 3, "Shop Item #2", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(12, 1, 1, 4, "Shop Item #3", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(13, 1, 1, 5, "Shop Item #4", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(14, 1, 1, 6, "Shop Item #5", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(15, 1, 1, 7, "Shop Item #6", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(16, 2, 0, 0, "Shop Item #7", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(17, 2, 0, 1, "Shop Item #8", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(18, 2, 0, 2, "Shop Item #9", ["Have money"], "Filler", "ShopItem"),
    SubXBitfield(19, 2, 0, 3, "Shop Item #10", ["Have money"], "Filler", "ShopItem"),
