...
subX_table = [
    ...
    SubXBitfield(63, 4, 1, 7, "Recycle Shop Dungeon #4", ["ProgressiveBag5", "Defeat Dialga", "Formation Control"], "Lake Afar",
                 "ShopItem"),
    SubXBitfield(64, 5, 0, 0, "Recycle Shop Dungeon #5", ["ProgressiveBag5", "Defeat Dialga",
