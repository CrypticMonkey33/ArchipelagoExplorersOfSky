...
subX_table = [
    SubXBitfield(0, 1, 0, 0, "Bag Upgrade 0", ["Beach Cave"], "Bag Upgrade", "ProgressiveBagUpgrade"),
    ...
    SubXBitfield(5, 1, 0, 5, "Bidoof's SE Location", [], "Bidoof's SE", "SEDungeonUnlock"),
    SubXBitfield(6, 1, 0, 6, "Igglybuff's SE Location", [], "Igglybuff's SE", "SEDungeonUnlock"),
    SubXBitfield(7, 1, 0, 7, "Sunflora's SE Location", [], "Sunflora's SE", "SEDungeonUnlock"),
    SubXBitfield(8, 1, 1, 0, "Team Charm SE Location", [], "Team Charm SE", "SEDungeonUnlock"),
    SubXBitfield(9, 1, 1, 1, "Grovyle + Dusknoir SE location", ["Hidden Land"], "Grovyle + Dusknoir SE",
                 "SEDungeonUnlock"),

    SubXBitfield(10, 1, 1, 2, "Shop Item #1", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(11, 1, 1, 3, "Shop Item #2", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(12, 1, 1, 4, "Shop Item #3", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(13, 1, 1, 5, "Shop Item #4", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(14, 1, 1, 6, "Shop Item #5", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(15, 1, 1, 7, "Shop Item #6", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(16, 2, 0, 0, "Shop Item #7", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(17, 2, 0, 1, "Shop Item #8", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(18, 2, 0, 2, "Shop Item #9", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(19, 2, 0, 3, "Shop Item #10", ["ProgressiveBag"], "Filler", "ShopItem"),
    SubXBitfield(20, 2, 0, 4, "Blue Goomi #1", ["Surrounded Sea"], "Filler", "Manaphy"),
    SubXBitfield(21, 2, 0, 5, "Blue Goomi #2", ["Surrounded Sea"], "Filler", "Manaphy"),
    SubXBitfield(22, 2, 0, 6, "Manaphy Healed", ["Surrounded Sea", "Miracle Sea"], "Filler", "Manaphy"),
    SubXBitfield(23, 2, 0, 7, "Manaphy's Gift", ["Defeat Dialga", "Surrounded Sea", "Miracle Sea"], "Manaphy", "Manaphy"),
    SubXBitfield(24, 2, 1, 0, "Manaphy's Discovery", ["Manaphy"], "Marine Resort", "Manaphy"),
    ...
    SubXBitfield(30, 2, 1, 6, "Palkia's Gift", ["Defeat Dialga", "Spacial Rift"], "Dialga",
                 "Legendary"),
    SubXBitfield(31, 2, 1, 7, "Aqua-Monica Location", ["Defeat Dialga", "Secret Rank", "Bottomless Sea"],
                 "Instrument"),
    ...
    SubXBitfield(46, 3, 1, 6, "Shaymin's Gift", ["Defeat Dialga", "Sky Peak Summit"], "Shaymin", "Legendary"),
    SubXBitfield(47, 3, 1, 7, "Scizor's Gift", ["Crevice Cave"], "Secret Rank", "SecretRank"),
    SubXBitfield(48, 4, 0, 0, "Aqua-Monica Mission", ["Secret Rank"], "Bottomless Sea", "LateSubX"),
    SubXBitfield(49, 4, 0, 1, "Terra Cymbal Mission", ["Secret Rank"], "Shimmer Desert", "LateSubX"),
    SubXBitfield(50, 4, 0, 2, "Icy Flute Mission", ["Secret Rank"], "Mt. Avalanche", "LateSubX"),
    SubXBitfield(51, 4, 0, 3, "Fiery Drum Mission", ["Secret Rank"], "Giant Volcano", "LateSubX"),
    SubXBitfield(52, 4, 0, 4, "Rock Horn Mission", ["Secret Rank"], "World Abyss", "LateSubX"),
    SubXBitfield(53, 4, 0, 5, "Sky Melodica Mission", ["Secret Rank"], "Sky Stairway", "LateSubX"),
    SubXBitfield(54, 4, 0, 6, "Grass Cornet Mission", ["Secret Rank"], "Mystery Jungle", "LateSubX"),
    SubXBitfield(55, 4, 0, 7, "Master ★ Rank", ["Secret Rank"], "Treacherous Waters", "OptionalSubX"),
    SubXBitfield(56, 4, 1, 0, "Master ★★ Rank", ["Secret Rank"], "Southeastern Islands", "OptionalSubX"),
    SubXBitfield(57, 4, 1, 1, "Master ★★★ Rank", ["Secret Rank"], "Inferno Cave", "OptionalSubX"),
    SubXBitfield(58, 4, 1, 2, "Guildmaster Rank", ["Secret Rank"], "Inferno Cave", "OptionalSubX"),
    SubXBitfield(59, 4, 1, 3, "Recycle Shop Treasure Found", [], "Filler", "Recycle0"),
    SubXBitfield(60, 4, 1, 4, "Recycle Shop Dungeon #1", [], "Landslide Cave", "Recycle0"),
    SubXBitfield(61, 4, 1, 5, "Recycle Shop Dungeon #2", ["ProgressiveBag1"], "Tiny Meadow", "Recycle1"),
    SubXBitfield(62, 4, 1, 6, "Recycle Shop Dungeon #3", ["ProgressiveBag1"], "Oran Forest", "Recycle1"),
    SubXBitfield(63, 4, 1, 7, "Recycle Shop Dungeon #4", ["ProgressiveBag2", "Formation Control"], "Lake Afar", "Recycle2"),
    SubXBitfield(64, 5, 0, 0, "Recycle Shop Dungeon #5", ["ProgressiveBag2", "Formation Control"], "Zero Isle Center", "Recycle2"),
    ...
    SubXBitfield(127, 8, 1, 7, "Team Name Location", [], "Team Name Trap")
]
